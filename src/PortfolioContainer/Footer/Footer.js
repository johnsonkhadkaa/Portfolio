    ...
    <footer className="mt-auto  ">
      ...
      <section className="d-flex justify-content-center justify-content-md-between p-4 border-bottom">
        <div className="footer-header">
          <span>
            <h3>Get connected on social networks:</h3>
          </span>
        </div>
        ...
        <div className="footer-header">
          <a
            href=""
            className="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4 me-4 text-reset"
          >
        ...
        <div className="container text-center text-md-start mt-5">
          <div className="row mt-3">
            <div className="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
              ...
              <p>This section contains the footer content</p>
            </div>
            ...
            <div className="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
              ...
              <p>
                <i className="fas fa-home me-3"></i> Babarmahal, Kathmandu 7707,
                NEPAL
              </p>
              <p>
              ...
              <p>
                <i className="fas fa-print me-3 me-4 text-reset"></i> + 01 234
                567 89
              </p>
            </div>
          </div>
